...
#[AsEntityListener(event: Events::preFlush, method: 'onPreFlush', entity: Contact::class)]
#[AsEntityListener(event: Events::preRemove, method: 'onPreRemove', entity: Contact::class)]
final class ContactUploadEventListener
{
    ...
    public function onPreFlush(Contact $object, EventArgs $args): void
    {
        $destinationDir = $this->getDestinationDir($object, true);

        if ($object->removeFile) {
    ...
    private function getDestinationDir(Contact $object, bool $forceCreation): string
    {
    ...
    public function onPreRemove(Contact $object, EventArgs $args): void
    {
        if ($object->getFilename() !== '') {
